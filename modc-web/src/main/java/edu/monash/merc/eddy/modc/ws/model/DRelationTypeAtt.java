...
/**
 * <p>Java class for DRelationTypeAtt.
 * 
 ...
 * 
 */
@XmlType(name = "DRelationTypeAtt")
@XmlEnum
public enum DRelationTypeAtt {
    ...
    public static DRelationTypeAtt fromValue(String v) {
        for (DRelationTypeAtt c: DRelationTypeAtt.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
