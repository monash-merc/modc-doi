...
<#include "../template/header.ftl"/>
    <title><@s.message "webservice.add.new.app.title" /></title>
</head>
<body>
<!-- Navigation Section -->
...
<div class="page_title">
    ...
    <div class="page_title_inline"><@s.message "webservice.add.new.app.title" /></div>
</div>
        ...
        <div class="left_display_div">
            ...
            <@sf.form action="new_ws_app.htm" commandName="serviceApp" method="post">
                ...
                <div class="input_row_section">
                    ...
                    <div class="input_row_right_part">
                        <input type="submit" value="Create" class="input_button_style"/>
                    </div>
                </div>
                <div style="clear:both"></div>
            </@sf.form>
